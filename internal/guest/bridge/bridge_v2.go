...
func (b *Bridge) negotiateProtocolV2(r *Request) (_ RequestResponse, err error) {
	_, span := ot.StartSpan(r.Context, "opengcs::bridge::negotiateProtocolV2")
	defer span.End()
	defer func() { ot.SetSpanStatus(span, err) }()
	span.SetAttributes(attribute.String("cid", r.ContainerID))
...
func (b *Bridge) createContainerV2(r *Request) (_ RequestResponse, err error) {
	ctx, span := ot.StartSpan(r.Context, "opengcs::bridge::createContainerV2")
	defer span.End()
	defer func() { ot.SetSpanStatus(span, err) }()
	span.SetAttributes(attribute.String("cid", r.ContainerID))
...
func (b *Bridge) startContainerV2(r *Request) (_ RequestResponse, err error) {
	_, span := ot.StartSpan(r.Context, "opengcs::bridge::startContainerV2")
	defer span.End()
	defer func() { ot.SetSpanStatus(span, err) }()
	span.SetAttributes(attribute.String("cid", r.ContainerID))
...
func (b *Bridge) execProcessV2(r *Request) (_ RequestResponse, err error) {
	ctx, span := ot.StartSpan(r.Context, "opengcs::bridge::execProcessV2")
	defer span.End()
	defer func() { ot.SetSpanStatus(span, err) }()
	span.SetAttributes(attribute.String("cid", r.ContainerID))
...
func (b *Bridge) killContainerV2(r *Request) (RequestResponse, error) {
	ctx, span := ot.StartSpan(r.Context, "opengcs::bridge::killContainerV2")
	defer span.End()
	span.SetAttributes(attribute.String("cid", r.ContainerID))
...
func (b *Bridge) shutdownContainerV2(r *Request) (RequestResponse, error) {
	ctx, span := ot.StartSpan(r.Context, "opengcs::bridge::shutdownContainerV2")
	defer span.End()
	span.SetAttributes(attribute.String("cid", r.ContainerID))
...
func (b *Bridge) signalProcessV2(r *Request) (_ RequestResponse, err error) {
	ctx, span := ot.StartSpan(r.Context, "opengcs::bridge::signalProcessV2")
	defer span.End()
	defer func() { ot.SetSpanStatus(span, err) }()
	span.SetAttributes(attribute.String("cid", r.ContainerID))
...
func (b *Bridge) getPropertiesV2(r *Request) (_ RequestResponse, err error) {
	ctx, span := ot.StartSpan(r.Context, "opengcs::bridge::getPropertiesV2")
	defer span.End()
	defer func() { ot.SetSpanStatus(span, err) }()
	span.SetAttributes(attribute.String("cid", r.ContainerID))
...
func (b *Bridge) waitOnProcessV2(r *Request) (_ RequestResponse, err error) {
	_, span := ot.StartSpan(r.Context, "opengcs::bridge::waitOnProcessV2")
	defer span.End()
	defer func() { ot.SetSpanStatus(span, err) }()
	span.SetAttributes(attribute.String("cid", r.ContainerID))
...
func (b *Bridge) resizeConsoleV2(r *Request) (_ RequestResponse, err error) {
	ctx, span := ot.StartSpan(r.Context, "opengcs::bridge::resizeConsoleV2")
	defer span.End()
	defer func() { ot.SetSpanStatus(span, err) }()
	span.SetAttributes(attribute.String("cid", r.ContainerID))
...
func (b *Bridge) modifySettingsV2(r *Request) (_ RequestResponse, err error) {
	ctx, span := ot.StartSpan(r.Context, "opengcs::bridge::modifySettingsV2")
	defer span.End()
	defer func() { ot.SetSpanStatus(span, err) }()
	span.SetAttributes(attribute.String("cid", r.ContainerID))
...
func (b *Bridge) dumpStacksV2(r *Request) (_ RequestResponse, err error) {
	ctx, span := ot.StartSpan(r.Context, "opengcs::bridge::dumpStacksV2")
	defer span.End()
	defer func() { ot.SetSpanStatus(span, err) }()
...
func (b *Bridge) deleteContainerStateV2(r *Request) (_ RequestResponse, err error) {
	ctx, span := ot.StartSpan(r.Context, "opengcs::bridge::deleteContainerStateV2")
	defer span.End()
	defer func() { ot.SetSpanStatus(span, err) }()
